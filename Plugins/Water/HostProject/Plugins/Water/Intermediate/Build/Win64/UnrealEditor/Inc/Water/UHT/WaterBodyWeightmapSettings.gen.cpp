...
template<> WATER_API UScriptStruct* StaticStruct<FWaterBodyWeightmapSettings>()
{
	...
	struct Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_WaterBodyWeightmapSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_WaterBodyWeightmapSettings_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_WaterBodyWeightmapSettings_h_72645133(TEXT("/Script/Water"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_WaterBodyWeightmapSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_WaterBodyWeightmapSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
