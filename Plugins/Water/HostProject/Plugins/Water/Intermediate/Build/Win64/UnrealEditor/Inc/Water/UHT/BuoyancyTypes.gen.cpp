...
template<> WATER_API UScriptStruct* StaticStruct<FBuoyancyData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_1534405384(TEXT("/Script/Water"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_BuoyancyTypes_h_Statics::EnumInfo));
