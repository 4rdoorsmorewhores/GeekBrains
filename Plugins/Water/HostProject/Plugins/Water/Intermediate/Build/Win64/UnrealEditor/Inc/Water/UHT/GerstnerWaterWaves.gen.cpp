...
#include "Runtime/Public/GerstnerWaterWaves.h"
...
template<> WATER_API UScriptStruct* StaticStruct<FGerstnerWaveOctave>()
{
	...
	struct Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_1213748402(TEXT("/Script/Water"),
		Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Skillbox_Plugins_Water_HostProject_Plugins_Water_Source_Runtime_Public_GerstnerWaterWaves_h_Statics::EnumInfo));
